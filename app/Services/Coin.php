...
class Coin
{
    ...
    private function coinTweetsData($sinceTime, $untilTime, $loopNumber)
    {
        ...
        //一致するテキストがあればカウントアップ
        for ($i = 0; $i < $count; $i++) {
            if (stristr($tweet_results[$i]['text'], "仮想通貨BTC") !== false) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨ETH") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨ETC") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨LISK") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨XRP") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨XEM") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨LTC") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨BCH") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨MONA") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨XLM") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨QTUM") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨BAT") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨IOST") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨ENJ") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨OMG") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨PLT") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨XYM") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨DASH") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨ZEC") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨XMR") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨REP") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
            ...
            if (stristr($tweet_results[$i]['text'], "仮想通貨FCT") !== false) {
                if ($sinceTime === $this->hourAgoTime) {
