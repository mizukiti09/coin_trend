...
class Coin
{
    ...
    {
        $search_key = '"cryptocurrency" OR "ビットコイン" OR "イーサリアム" OR "イーサリアムクラシック" OR "仮想通貨リスク" OR "リップル" OR "仮想通貨ネム" OR "ライトコイン" OR "ビットコインキャッシュ" OR "モナコイン" OR "ステラルーメン" OR "クアンタム" 
        OR "ベーシックアテンショントークン" OR "アイオーエスティー" OR "エンジンコイン" OR "オーエムジー" OR "パレットトークン" OR "シンボルコイン" OR "ダッシュコイン" OR "ジーキャッシュ" OR "モネロ" OR "オーガーコイン" OR "ファクトム"
        ';
